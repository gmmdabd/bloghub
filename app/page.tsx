  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
        ...
        <header className="sticky top-0 z-50 bg-[#f5f2e8]/90 backdrop-blur-md border-b border-amber-100">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav className="hidden md:flex space-x-6">
              <a href="#" className="text-amber-900 hover:text-amber-600 font-medium transition">Home</a>
              <a href="#" className="text-amber-900 hover:text-amber-600 font-medium transition">Destinations</a>
              <a href="#" className="text-amber-900 hover:text-amber-600 font-medium transition">Travel Guides</a>
              <a href="#" className="text-amber-900 hover:text-amber-600 font-medium transition">About</a>
            </nav>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6 text-white">
                <h1 className="text-4xl md:text-5xl font-bold leading-tight drop-shadow-lg">Explore the World, One Journey at a Time</h1>
                <p className="text-xl text-white/90 drop-shadow">Join our community of passionate travelers sharing authentic experiences and practical travel tips.</p>
                <div className="flex flex-wrap gap-4">
                  <button className="px-6 py-3 bg-amber-600 text-white font-medium rounded-full hover:bg-amber-700 transition shadow-md hover:shadow-lg">Start Your Journey</button>
                  <button className="px-6 py-3 bg-white/90 text-amber-800 font-medium rounded-full border border-amber-200 hover:bg-white transition">Explore Destinations</button>
                </div>
              </div>
        ...
        <section className="py-16 bg-[#f5f2e8] px-4">
          <div className="container mx-auto max-w-6xl">
        ...
        {/* Demo Video Section */}
        <section className="py-16 bg-[#f8f5eb] px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-amber-900">See TravelHub in Action</h2>
              <p className="text-amber-800 max-w-2xl mx-auto">Watch how easy it is to create beautiful travel posts, engage with fellow travelers, and plan your next adventure.</p>
            </div>
            ...
            <div className="aspect-video max-w-4xl mx-auto bg-gray-200 rounded-xl overflow-hidden shadow-xl relative">
              ...
              <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                <button className="w-20 h-20 rounded-full bg-amber-600 flex items-center justify-center shadow-lg hover:bg-amber-700 transition">
                ...
                <article key={post.id} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group border border-amber-100">
                  <div className="aspect-video bg-gray-200 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-tr from-black/20 to-transparent z-10 flex items-center justify-center">
                      <div className="bg-white/90 px-3 py-1 rounded-full text-sm font-medium text-amber-700 z-20">
        ...
        <section className="py-16 bg-[#f8f5eb] px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-amber-900">What Our Travelers Say</h2>
              <p className="text-amber-800 max-w-2xl mx-auto">Hear from some of our adventurous community members</p>
            </div>
        ...
        <section className="py-16 bg-gradient-to-r from-amber-600 to-orange-500 text-white px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-white/90 text-lg mb-8">Join thousands of travelers who have already found inspiration and shared their journeys on our platform.</p>
